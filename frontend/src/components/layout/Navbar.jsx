...
const NAV_LINKS = ["Home", "Jobs", "Dashboard", "Resume Analysis", "About"];
...
export default function Navbar({ activePage, onNavigate, isLoggedIn, user, onLogout }) {
  ...
  const visibleLinks = isLoggedIn ? NAV_LINKS : NAV_LINKS.filter((link) => link !== "Dashboard");
              ...
              {isLoggedIn ? (
                <>
                  ...
                  {[
                    ...
                    { label: "Applications", page: "Dashboard" },
                  ].map((item) => (
